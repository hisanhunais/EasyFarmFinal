...
<?php
	...
	// $sql1="SELECT * FROM fer_ordertable WHERE Fertilizer_username = '".$_SESSION["username"]."' AND status = 'Pending' ORDER BY Fer_date DESC";
	$sql1="SELECT * FROM fer_ordertable WHERE Fertilizer_username = 'Amal' AND status = 'Pending' ORDER BY Fer_date DESC";
	$res1=mysqli_query($con,$sql1) or die(mysqli_error($con));

	$sql2="SELECT * FROM fer_ordertable WHERE Fertilizer_username = '".$_SESSION["username"]."' AND status = 'Completed' ORDER BY Fer_date DESC";
