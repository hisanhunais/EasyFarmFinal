        ...
        <div class="row">
            <div class="col-md-3">
                <!--<div class="list-group">
                    ...
                    <a href="paddyOrder.php" id="paddyOrderBtn" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Paddy Orders</a>
					  ...
					  <div class="panel-body">
							...
							<div class = "col-md-12" id="loadSection">
								<ul class="nav nav-tabs">
								  <li class="active"><a data-toggle="tab" href="#farmers">Farmers</a></li>
								  <li><a data-toggle="tab" href="#millOwners">Mill Owners</a></li>
								  <li><a data-toggle="tab" href="#fertilizerSellers">Fertilizer Sellers</a></li>
								  <li><a data-toggle="tab" href="#storeOwners">Store Owners</a></li>
								  <li><a data-toggle="tab" href="#paddyMarketingBoard">Paddy Marketing Board</a></li>
