            ...
            <div class="col-md-9">
                    <div class="panel panel-default">
                      <div class="panel-heading main-color-bg">
                        <h3 class="panel-title">Paddy Type</h3>
                      ...
                      <div class="panel-body">
                        <div class="row" style="margin-bottom: 10px;">
                            <div class="col-md-offset-10">
                                <center>
                                <button class="btn btn-success"  data-toggle='modal' title="Insert Paddy Details" data-target="#adddata" style="font-family: arial;"><span class="glyphicon glyphicon-plus-sign" > Add </span></button>
                                </center>
                        ...
                        <div class="row">
                            <div class = "col-md-12" id="loadSection">
                                 <?php include('viewannouncement.php'); ?>       
                            </div>
                        </div>
