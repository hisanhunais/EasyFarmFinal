...
function fetch_data()
{
    ...
    $sql = "SELECT * FROM tp_paddygraph WHERE Year_pro  LIKE '%$selectyear%' and username LIKE '%$sessionID%' AND season='all'";
    $result = mysqli_query($conn, $sql);
    while($row = mysqli_fetch_array($result))
    {
        $output .= '<tr>  
                          <td>'.$row["Total_Pro"].'</td>  
                          <td>'.$row["Total_provalue"].'</td> 
...
if(isset($_POST["generate_pdf"]))
{
    ...
    $content .= '  
      ...
      <h2 align= "center"> Farmer Profile 
      </h2>
      <br><br>
      <hr>
      ...
      <table align="center" border="0" cellspacing="0" cellpadding="3" border="1">  
           <tr>  
                <th width="50%"><b>Total Production In Metric tons</b></th>  
                <th width="50%"><b>Total Production cost in (Rs.)</b></th>
