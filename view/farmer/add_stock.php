<?php
	...
	if(!empty($_POST))
	{
		...
		else if($_POST['paddyID'] == '' )
		{
			$query11 = "SELECT * FROM paddy";
			$query_run11 = mysqli_query($con,$query11);
			
			
			$oldno = mysqli_num_rows($query_run11);
			...
			$query = "INSERT INTO paddy VALUES('$newid','$name','$price','$qty','$date','$username',0,'Yala','2017/2018')";
