...
$homeActive = $harvestActive = $paddyOrderActive = $transportActive = $ferOrderActive = $announcementActive = $discussionForumActive = $reportActive = '';
...
switch(basename($_SERVER['PHP_SELF'])) {
    ...
    case 'ferOrder.php':
        $ferOrderActive = $active;
    break;

     case 'ferProductPage.php':
        $ferOrderActive = $active;
    break;
...
<div class="list-group">
    ...
    <a href="ferOrder.php" id="fertilizerOrderBtn" class="list-group-item <?php echo $ferOrderActive;?>"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Fertilizer Orders</a>
    ...
    <a href="announcement.php" id="announcementBtn" class="list-group-item <?php echo $announcementActive;?>"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Announcements<span class="badge countAn"></span></a>
