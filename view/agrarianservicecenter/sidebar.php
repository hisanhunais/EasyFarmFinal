...
<div class="list-group">
    ...
    <a href="agrariandiscussion.php" class="list-group-item <?php echo $discussionActive;?>"><span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span> Discussion Forum</a>
