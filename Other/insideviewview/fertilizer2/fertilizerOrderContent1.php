...
<?php
	...
	$sql1="SELECT * FROM fer_ordertable WHERE Fertilizer_username = 'Sumal Dissanayake' AND Status = 'Pending' ORDER BY Fer_date DESC";
	$res1=mysqli_query($con,$sql1) or die(mysqli_error($con));

	$sql2="SELECT * FROM fer_ordertable WHERE Fertilizer_username = 'Sumal Dissanayake' AND Status = 'Completed' ORDER BY Fer_date DESC";
